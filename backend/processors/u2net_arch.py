...
--------------------
Vendored from: https://github.com/xuebinqin/U-2-Net
Original paper: "U^2-Net: Going Deeper with Nested U-Structure for Salient Object Detection"
(Qin et al., Pattern Recognition 2020)

This file contains only the model architecture (no training code).
"""
...
class U2NET(nn.Module):
    """Full U²-Net (large variant, 176MB weights)."""
    ...
    def forward(self, x):
        ...
        # Side outputs + fusion
        d1 = self.side1(hx1d)
        d2 = _upsample_like(self.side2(hx2d), hx1d)
        d3 = _upsample_like(self.side3(hx3d), hx1d)
        d4 = _upsample_like(self.side4(hx4d), hx1d)
        d5 = _upsample_like(self.side5(hx5d), hx1d)
        d6 = _upsample_like(self.side6(hx6), hx1d)
